  ...
  return (
    <div className="fixed top-0 z-50 max-w-2xl w-full">
      {menu && (
        <div className="bg-black fixed top-0 z-50 w-full h-full ">
          <div className="h-screen">
            <motion.div className="flex bg-transparent items-center justify-between mx-4 my-2 sm:mx-6 sm:my-3 bg-black">
      ...
      <div className="bg-black ">
        <div className="flex bg-black items-center justify-between mx-5 my-2 sm:mx-6 sm:my-3">
          <Link href="/" className="">
            <img
              src="/assets/brand/logowhiteupdated.png"
              alt="logo"
              className="h-10 sm:h-12 mb-1"
            ></img>
          </Link>
