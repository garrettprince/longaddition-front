...
function Nav() {
  ...
  return (
    <div className="fixed top-0 z-50 max-w-2xl w-full">
      {menu && (
        <div className="bg-black fixed top-0 z-50 w-full h-full ">
          <div className="h-screen">
            <motion.div className="flex bg-transparent items-center justify-between mx-6 my-3 bg-black">
      ...
      <div className="bg-black ">
        <div className="flex bg-black items-center justify-between mx-4 my-1 sm:mx-6 sm:my-3">
          <Link href="/" className="">
            <img
              src="/assets/brand/logowhiteupdated.png"
              alt="logo"
              className="h-9 sm:h-11 mb-1"
            ></img>
          </Link>
          <div className=" flex space-x-2 items-center">
            ...
            <div className="hidden sm:flex space-x-5 font-mono text-lg mt-1 mb-1">
              <Link href="/about" className="">
                <p className="bg-transparent ml-2">ABOUT</p>
              </Link>
              <Link href="/contact" className="bg-black">
      ...
      {/* <div className="bg-transparent bg-gradient-to-b from-black w-full h-2 backdrop-blur-"></div> */}
    </div>
  );
}
