...
import PremiumIconRight from "./PremiumIconRight";
import PremiumIconLeft from "./PremiumIconLeft";
      ...
      {type === "photoRight" && (
        ...
        >
          ...
          >
            ...
            {premium && (
              <img
                className="absolute right-1 bottom-1 rotate-12 bg-transparent h-24 w-24 sm:h-36 sm:w-36"
                alt=""
                src="https://res.cloudinary.com/dvwbpgk6p/image/upload/v1681002815/Long%20Addition/Branding/premiumstartalt_e6ntwc.png"
              />
            )}
          </Link>
        </motion.div>
      ...
      {type === "photoLeft" && (
        ...
        >
          ...
          >
            ...
            {premium && (
              <img
                className="absolute left-1 bottom-1 rotate-[-20deg]  bg-transparent h-24 w-24 sm:h-36 sm:w-36"
                alt=""
                src="https://res.cloudinary.com/dvwbpgk6p/image/upload/v1681002815/Long%20Addition/Branding/premiumstartalt_e6ntwc.png"
              />
            )}
