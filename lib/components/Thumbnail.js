    ...
    <div>
          ...
          >
            <div className="z-10 col-start-[-1] col-end-4 bg-transparent font-bold row-start-1 row-end-2 text-end">
              ...
              {/* <div
                className={
                  premium === true
                    ? `${"font-mono text-xs bg-gradient-to-tr from-cta-gradient-1 to-cta-gradient-2 h-5 rounded-md px-2 pt-[.1rem] py-1 w-20"}`
                    : `${"hidden"}`
                }
              >
                <div className="bg-transparent flex">
                  <StarIcon className="bg-transparent pb-[.15rem]" />
                  <p className="bg-transparent">PREMIUM</p>
                </div>
              </div> */}
      ...
      {type === "newsletterCtaLarge1" && (
        <motion.div
          ...
          animate={{ y: -3, opacity: 1 }}
          transition={{ ease: "easeOut", duration: 0.2 }}
          className="sm:mx-10 sm:mb-20 mb-16"
        >
