...
function ThumbnailTRMRPL({ link, title, titleSize, date, category, duration, photo }) {
  return (
    /////////////////////////////////////////////
    ...
    >
      <div className="z-10 col-start-[-1] col-end-4 bg-transparent font-bold row-start-1 row-end-2 text-end text-2xl">
        <h1
          className={
            titleSize === "text-2xl"
